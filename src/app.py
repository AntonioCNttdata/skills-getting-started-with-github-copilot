...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practice and games for basketball enthusiasts",
    ...
    "Drama Club": {
        "description": "Acting practice, stagecraft, and performance projects",
        "schedule": "Mondays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu", "lucas@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Creative visual arts and hands-on studio time",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["mia@mergington.edu", "elijah@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Design and build robots, then compete in robotics challenges",
